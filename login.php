...
<section id="login" class="center">
    ...
    <!-- <div class="spacer"></div> -->
        ...
        <input type="password" placeholder="Passwort" name="password" id="password">
            <div id="inside-input" class="text-link small-text"><a href="forgotpassword.php">Passwort vergessen?</a></div> 
        </input>         
        <input class="default-button color-primary" type="submit" value="Log in" id="submit" name="submit"></input>
